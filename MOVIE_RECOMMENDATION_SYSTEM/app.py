...
def find_recommendation(n, num_recommendations=10):
...
def index():
    if request.method == 'POST':
        ...
        result = movies_info[movies_info['title'].str.contains(movie_name, case=False, regex=False)]
...
if __name__ == '__main__':
    # Read movies dataset
    movies_info = pd.read_csv("C:\\Users\\RAJDEEP CHAKRAVORTY\\Downloads\\MOVIE RECOMMENDATION\\movie.csv")
